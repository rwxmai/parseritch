...
# (ITCH_BUILD, default build-dev).
bdir="$root/${ITCH_BUILD:-build-dev}"
...
# itch_slice: frame-aligned slices and time cuts of a session file (native).
$CXX -std=c++20 -O2 "${ARM[@]}" "$here/itch_slice.cpp" -o "$out/itch_slice"
